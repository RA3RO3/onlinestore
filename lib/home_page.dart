...
class HomePage extends StatelessWidget {
 ...
 final items = [
  {'icon': 'assets/processor.png',
    'title': 'Processor',
      'subtitle': 'Intel Core i7-9700K',
        'price': '\$299.99',
          'description': 'High-performance 9th generation processor.'},
  {'icon': 'assets/ssd.png',
    'title': 'SSD', 'subtitle': 'Samsung 970 EVO 1TB',
      'price': '\$149.99',
  ...
  {'icon': 'assets/mouse.png',
    'title': 'Gaming Mouse',
      'subtitle': 'Logitech G502',
        'price': '\$49.99',
          'description': 'High-precision mouse with customizable weights.'},
  ...
  {'icon': 'assets/headphone.png',
    'title': 'Headphone',
      'subtitle': 'HyperX Cloud II',
        'price': '\$99.99',
          'description': 'Comfortable headset with virtual 7.1 surround sound.'},
  {'icon': 'assets/monitor.png',
    'title': 'Monitor',
      'subtitle': 'Dell UltraSharp 27 4K',
        'price': '\$449.99',
          'description': 'Stunning 4K monitor with wide color coverage.'},
];
